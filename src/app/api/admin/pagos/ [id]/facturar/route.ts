...
export async function POST(
    ...
    try {
        ...
        const pagoActualizado = await prisma.pago.update({
            ...
            data: {
                cae: fiscalData.cae,
                caeVencimiento: new Date(fiscalData.caeVencimiento.slice(0, 4), parseInt(fiscalData.caeVencimiento.slice(4, 6)) - 1, parseInt(fiscalData.caeVencimiento.slice(6, 8))),
                puntoVenta: fiscalData.puntoVenta,
